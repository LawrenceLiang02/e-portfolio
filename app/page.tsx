        ...
        <div className="flex flex-row w-full h-full absolute top-0 left-0 bg-[#434b8f] text-[#FFD700] ">
          ...
          <div className="flex flex-col items-center justify-around z-20 space-y-8">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex-grow h-[6px] w-full bg-white rounded-full"> </div>
            </div>
        ...
        <div id="aboutme" className="z-6 snap-start bg-blue-200 relative  w-full h-full flex flex-row items-start justify-center px-[20%] py-32 font-open-sans">
          ...
          <div className="flex flex-col items-center w-full h-full space-y-8">
            <div className="flex flex-row items-start justify-between w-full h-full space-x-16">
              ...
              <div className="flex flex-col space-y-4 h-full w-3/5 z-20">
                ...
                <div className="flex flex-col items-start h-full w-full space-y-4">
                  ...
                  <div className="flex flex-row flex-wrap justify-normal items-start font-exo-2 text-lg w-full h-full shadow-lg bg-white rounded-2xl p-6 space-x-1">
