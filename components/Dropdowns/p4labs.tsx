        ...
        <div className='flex flex-col w-full h-auto hover:scale-[102%]'>
            <div onClick={() => setExtendCAE(!isExtendedCAE)} className={` ${isExtendedCAE ? "z-10": "z-30"} flex flex-row bg-white rounded-2xl w-full h-auto justify-around items-center shadow-lg px-6 py-4 ease-in-out duration-200 hover:cursor-pointer space-x-6 font-exo-2`}>
                ...
                <div className="flex flex-col space-y">
                    ...
                    <p className="text-sm md:text-md font-semibold text-blue-400">P4Labs</p>
                    <p className="text-sm md:text-md">Mar 2021 – May 2021</p>
                </div>
            ...
            <div className={` ${isExtendedCAE ? "-translate-y-6 opacity-100 z-11 h-auto ": "-translate-y-full opacity-0 z-0 h-0"} text-sm md:text-md bg-[#fcfcfc] w-full rounded-b-lg shadow-lg ease-in-out duration-200`} >
