...
import lawrence from '@/public/IMG_0609.jpg'
    ...
    return (
        <div className="w-full h-44 md:h-full p-3 z-20 pr-6 group perspective hover:scale-[105%] ease-in-out duration-200">
            <div 
                ...
                <p className='font-exo-2 text-2xl'>Find Me!</p>
                <div className='flex flex-row items-center justify-around w-full h-auto'>
                    <a href="https://www.linkedin.com/in/lawrence-liang-b19a3b199/" className='hover:scale-[110%] ease-in-out duration-200 w-16 h-16'>
                    ...
                    <a href="https://github.com/LawrenceLiang02" className='hover:scale-[110%] ease-in-out duration-200 w-16 h-16'>
                    ...
                    <a href="mailto:lawrencekaiwei@gmail.com" className='hover:scale-[110%] ease-in-out duration-200 w-16 h-16'>
